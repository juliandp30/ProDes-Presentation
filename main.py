...
if submitted1:
    ...
    fig.update_layout(font_size=20, plot_bgcolor='rgba(180, 180, 180, 0.3)')
    fig.update_xaxes(title="Opciones de refuerzo", visible=True, showticklabels=False)
    fig.update_yaxes(title="Precio", visible=True, showticklabels=True, dtick=5000000)
    ...
    fig.update_layout(font_size=20, plot_bgcolor='rgba(180, 180, 180, 0.3)')
    fig.update_xaxes(title="Precio", visible=True, showticklabels=True, dtick=5000000)
    fig.update_yaxes(title="Puntaje", visible=True, showticklabels=True, dtick=0.25)
    ...
    fig.update_layout(font_size=20, plot_bgcolor='rgba(180, 180, 180, 0.3)')
    fig.update_xaxes(title="Opciones de refuerzo", visible=True, showticklabels=False)
    fig.update_yaxes(title="# Piezas", visible=True, showticklabels=True, dtick=2000)
